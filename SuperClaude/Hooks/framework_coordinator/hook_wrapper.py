#!/usr/bin/env python3
"""
Hook Wrapper for Framework Coordinator
...
def main():
    ...
    try:
        ...
        if event_type == 'pre':
            ...
            cmd = ['python3', hook_script, 'pre', tool_name, json.dumps(tool_input), session_id]
        
        elif event_type == 'post':
            tool_input = input_data.get('tool_input', {})
            # Note: PostToolUse may not have tool_result in the new format
            # We'll pass empty result for now and rely on tool_input
